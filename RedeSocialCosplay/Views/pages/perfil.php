            ...
            <div class="editar-perfil">
				...
				<?php
					if(isset($_SESSION['img']) && $_SESSION['img'] == ''){
						echo '<img style="max-width:200px;width:100%;" src="'.INCLUDE_PATH_STATIC.'images/avatar.jpg" />';
					}else{
					echo '<img style="max-width:200px;width:100%;" src="'.INCLUDE_PATH.'/'.$_SESSION['img'].'" />';
					}
				?>
				<br/>
